...
import CycleCreateDialog from "@/app/(DashboardLayout)/components/cycles/CycleCreateDialog";
...
const CiclosPageClient = ({ initialCiclos }: CiclosPageClientProps) => {
  ...
  const handleCreateSuccess = React.useCallback(
    ({ cycleId }: { cycleId: number }) => {
      ...
      setSnackbarState({
        open: true,
        message: `Ciclo #${cycleId} creado correctamente`,
        severity: "success",
      });
      router.refresh();
    },
        ...
        <Stack spacing={3}>
          ...
          <Box>
            ...
            <Typography
              ...
              sx={{ maxWidth: "800px" }}
            >
              Explora los ciclos por campaña, campo y cultivo, y accede al
              detalle de cada uno.
            </Typography>
          </Box>
